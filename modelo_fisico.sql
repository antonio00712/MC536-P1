...
DROP TABLE IF EXISTS rendimento_escolar CASCADE;
CREATE TABLE IF NOT EXISTS rendimento_escolar (
...
\copy infraestrutura(NU_ANO_CENSO, CO_ENTIDADE, IN_AREA_VERDE, IN_BANHEIRO, IN_BIBLIOTECA, IN_LABORATORIO_INFORMATICA) from '/tmp/data/dependencias_parsed.csv' DELIMITER ',' CSV HEADER;
...
\copy funcionarios(NU_ANO_CENSO, CO_ENTIDADE, QT_PROF_SAUDE, QT_PROF_PSICOLOGO, QT_PROF_ASSIST_SOCIAL) from '/tmp/data/corpo_docente_parsed.csv' DELIMITER ',' CSV HEADER;
\copy rendimento_escolar(NU_ANO_CENSO, CO_ENTIDADE, FUNDAMENTAL, ENSINO_MEDIO) from '/tmp/data/serie_parsed.csv' DELIMITER ',' CSV HEADER;
